...
def criar():
    ...
    nome = form.nome.data #para resgatar o nome do html
...
def editar(id):
    ...
    form = FormularioJogo()
    form.nome.data = jogo.nome #acessando os valores do input nome
    form.categoria.data = jogo.categoria
    form.console.data = jogo.console
    capa_jogo = recupera_imagem(id)
    return render_template('editar.html', titulo='Editando Jogo', id=id, capa_jogo=capa_jogo, form=form)

@app.route('/atualizar', methods= ['POST',]) #methods para falar quais métodos eu quero
def atualizar():
    form = FormularioJogo(request.form)
